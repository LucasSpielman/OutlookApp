...
app.layout = html.Div([
    ...
    dcc.Graph(id='map-plot', style={"width": "100vw", "height": "50vh"}),
    dcc.Graph(id='scatter-plot', style={"width": "100vw", "height": "50vh"})
