...
app.layout = dbc.Container([
    # Title row
    dbc.Row([
        dbc.Col(html.H1(id='app-title', style={'textAlign': 'Left', 'margin-top': '30px'}), width=10),
        dbc.Col(dbc.Button("Info", id="open-modal", color="primary"), width=2, style={'textAlign': 'right', 'margin-top': '15px'})
    ]),
    ...
    dbc.Row([
        dbc.Modal(
            [
                ...
                dbc.ModalBody(dcc.Markdown(id='modal-info-text')),
                dbc.ModalFooter(
