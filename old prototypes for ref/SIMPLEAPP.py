...
# Callback to update region dropdown options based on the selected language
@app.callback(
...
def update_region_dropdown(language):
    """
    Update the Economic Region dropdown options and value based on the selected language.

    Parameters:
    language (str): The selected language ('English' or 'French').

    Returns:
    tuple: A tuple containing the dropdown options and the first Economic Region name as the default value.
    """
...
def update_plots(selected_region, language):
    """
    Update the map and bar plots based on the selected Economic Region and language.
    ...
    # Filter the DataFrame by the selected Economic Region
    filtered_df = merged_df[merged_df['Economic Region Name'] == selected_region]
